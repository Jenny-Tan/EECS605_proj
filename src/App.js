    ...
    <div className="split left">
      ...
      <h1>Input</h1>
        <form onSubmit={handleSubmitDebug}>
          ...
          <div>
            <label htmlFor="initial_money" style={{color : 'white';font-family: "Brush Script MT", cursive; font-size: 14px; font-style: normal; font-variant: normal; font-weight: 400; line-height: 20px;}}>Initial money to invest (from 1000 to 1e6): </label>
